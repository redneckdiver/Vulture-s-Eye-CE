...
#endif
#if defined(VULTURE_UNNETHACK) || defined(VULTURE_NETHACK_3_6_7)
		...
		* at the start of the turn and dealing with them manually is ugly */
		...
		if ((obj = vobj_at(x,y)) && !covers_objects(x,y)) {
			...
			* corpses... */
			map_obj =
#ifdef VULTURE_NETHACK_3_6_7
        vulture_object_to_tile(glyph_to_obj(obj_to_glyph( obj,rn2_on_display_rng)), x, y, NULL);
#else
        vulture_object_to_tile(glyph_to_obj(obj_to_glyph( obj)), x, y, NULL);
#endif
		}
